  ...
  return (
    <header className="sticky top-0 z-50 border-b border-sky-100/80 bg-white/70 backdrop-blur-2xl">
      <div className="mx-auto flex min-h-[5rem] max-w-6xl flex-wrap items-center justify-between gap-3 px-6 py-3">
        <VigilLogo size={46} showWordmark />
        {variant === "default" && (
          <nav className="flex flex-wrap items-center justify-end gap-1 rounded-2xl border border-slate-200/80 bg-white/75 p-1.5 shadow-lg shadow-sky-100/40">
            ...
            <Link
              href="/claim"
              className="ml-1 inline-flex items-center rounded-xl bg-gradient-to-r from-sky-600 via-sky-500 to-cyan-500 px-4 py-2 text-sm font-semibold text-white shadow-md shadow-sky-500/30 transition-all duration-200 hover:translate-y-[-1px] hover:from-sky-700 hover:via-sky-600 hover:to-cyan-600"
            >
              Start now
            </Link>
          </nav>
